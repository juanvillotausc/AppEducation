            ...
            <View style={styles.boxButtons}>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View style={{ flex: 1, paddingvertical: 20, display: 'flex', justifyContent: 'space-around' }}>
                        ...
                        <Button title="8" onPress={() => alert('¡Respuesta correcta!')} />
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View style={{ flex: 1, paddingvertical: 20, display: 'flex', justifyContent: 'space-around' }}>
                        <Button title="8" onPress={() => alert(resultErrorResta)} />
                        <Button title="13" onPress={() => alert(resultErrorResta)} />
                        < Button title="2" onPress={() => alert('¡Respuesta correcta!')} />
                    </View>
                </View>
